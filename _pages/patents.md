...
<table border="1" style="table-layout: fixed; width: 100%; word-break: break-all; font-size: 0.5em; line-height: 1.2;"> 
  <tr> 
    <th align="center" style="width: 3%; padding: 2px;">No.</th> 
    ...
    <th align="center" style="width: 30%; padding: 2px;">Abstract (in Chinese)</th> </tr> 
  ...
  <tr>
    ...
    <td style="padding: 2px;">2025.01.17（Authorized）</td> 
  ...
  <tr>
    ...
    <td style="text-align: justify; padding: 4px;">本发明提出一种面向低GPU资源卡群计算系统的大模型计算方法和装置，包括：将部分大语言模型的参数卸载至GPU资源卡群计算系统中的CPU内存中；获取推理请求，推理请求包含批处理大小和序列长度；在处理提示词阶段判断序列长度是否大于大语言模型隐藏层维度的两倍，若是，则分别计算大语言模型所有注意力层和所有多层感知机的计算强度；判断所有注意力层的计算强度是否大于多层感知机，若是，则将所有注意力层卸载在GPU显存中，将所有多层感知机卸载在CPU内存中，否则将所有多层感知机放卸载在GPU显存中，将所有注意力层卸载在CPU内存中；使用卸载完成后的该GPU资源卡群计算系统运行该大语言模型进行推理，得到该推理请求的推理结果。</td> </tr> 
  ...
  <tr>
    ...
    <td style="text-align: justify; padding: 4px;">本发明公开一种便携加固式训推一体计算设备及其设计方法，设备包含：机箱及折叠设置于机箱的上翻盖式屏幕，还包含：电源、主板及多张加速卡，电源设置于机箱的一侧；主板设置于机箱的另一侧，电连接电源；多张加速卡设置于主板一侧扩展区，加速卡包括：垂直设置的多张智能加速卡及水平设置的网卡，加速卡采用集中式布局，且用于实现训推一体功能。本发明设备在高度紧凑环境下实现了高算力密度，适用于多种可变场景下的实时AI训练与推理任务。</td> </tr> 
</table>
